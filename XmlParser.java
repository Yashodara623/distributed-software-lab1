...
public class XmlParser {
    public static void main(String[] args) {
        ...
        // Parse the XML file
        Document document = builder.parse("C:\\Users\\student\\Desktop\\EA\\XML\\src\\xml\\books.xml");
        ...
        NodeList nodeList = document.getElementsByTagName("book");
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    StreamResult result = new StreamResult(new File("C:\\Users\\student\\Desktop\\EA\\XML\\src\\xml\\updated_books.xml"));
